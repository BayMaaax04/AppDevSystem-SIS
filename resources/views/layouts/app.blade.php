    ...
    <div id="app">
        ...
        <header class="dark:bg-gray-secondary-dark bg-white lg:px-20 px-6 flex flex-wrap items-center lg:py-0 py-2 fixed top-0 w-full z-10">
              ...
              <div class="relative flex justify-between center lg:flex-1">
                  <a href="/student" class="text-lg font-semibold text-white-500 dark:text-white-700 no-underline flex">
              ...
              <div class="lg:relative absolute lg:right-0 lg:top-0 right-2 top-2 flex-end flex justify-end">
                ...
                <div x-data="{ dropdownOpen: false }" class="lg:relative">
                  ...
                  <div x-show="dropdownOpen" class="absolute right-0 mt-1 w-80 pb-2 z-50  bg-white dark:bg-gray-secondary-dark rounded-lg shadow-xl divide-y-1 divide-gray-200 ">
                    ...
                    <div class="px-2 py-1">
                      <a href="{{ route('user.accountSettings') }}" class="block px-4 py-3 text-gray-800 dark:text-white  hover:text-red-800 dark:hover:text-red-800 transition ease-in ">Account Settings</a>
