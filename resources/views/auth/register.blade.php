                ...
                <form class="w-full h-full px-6 sm:px-10 sm:space-y-1" method="POST"
                    ...
                    <div class="" x-data="{ show: true }">
                        <div class="txtb">
                            ...
                            <input id="password" type="password"
                                ...
                                autocomplete="new-password" :type="show ? 'password' : 'text'">
                    ...
                    <div class="" x-data="{ show: true }">
                        <div class="txtb">
                            ...
                            <input id="password-confirm" type="password" class="" name="password_confirmation" autocomplete="new-password" :type="show ? 'password' : 'text'">
