    ...
    <div class="flex w-full min-h-screen">
        <div class="lg:w-2/4 w-full">
            <section class="flex flex-col items-center break-words bg-white sm:border-1 sm:rounded-md py-10">
                ...
                <form class="w-full h-full px-6 sm:px-10 sm:space-y-18" method="POST" action="{{ route('login') }}">
                    <br>
                    @csrf
                    ...
                    <div class="flex items-center justify-center">
                        <button type="submit"
                        class="mt-5 btn-reg block w-2/3 border-none rounded-lg bg-red-accent text-white outline-none cursor-pointer transition hover:bg-red-800">
                            {{ __('Login') }}
                        </button>
                    </div>
                    <br>
