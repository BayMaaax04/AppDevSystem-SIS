        ...
        <div class="lg:w-2/4 w-full">
            <section class="flex flex-col items-center break-words bg-white sm:border-1 sm:rounded-md py-10">
                ...
                <header class="flex flex-col items-center">
                    ...
                    <h1 class="mt-4 font-bold text-sm">{{ __('Sign in') }}<span class="font-normal "> {{ __('to start your session') }}</span></h1>
                </header>

                <form class="w-full h-full px-6 sm:px-10" method="POST" action="{{ route('login') }}">
                    <br>
                    @csrf
                    ...
                    <div>
                        <div class="txtb">
                            ...
                            <span class="text-sm" data-placeholder="Email"></span>
                        </div>
                        @error('email')
                    ...
                    <div class="" x-data="{ show: true }">
                        <div class="txtb">
                            ...
                            <span class="text-sm" data-placeholder="Password"></span>

                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5">

                                <svg class="h-4 text-gray-700 cursor-pointer" fill="none" @click="show = !show"
                    ...
                    <div class="flex items-center">
                        ...
                        <a class="text-sm text-red-900 hover:text-red-700 whitespace-no-wrap no-underline hover:underline ml-auto"
                    ...
                    <p class="w-full text-xs text-center text-gray-700 sm:text-sm">
                        ...
                        <a class="text-red-accent hover:text-red-700 no-underline hover:underline" href="{{ route('register') }}">
                            {{ __('Sign Up') }}
                        </a>
                    </p>
                    @endif
...
<script type="text/javascript">
    ...
    const buttons = document.querySelector('.btn-reg')
    buttons.addEventListener('click', function(e){
        let x= e.clientX - e.target.offsetLeft;
        let y= e.clientY - e.target.offsetTop;

        let ripple = document.createElement('em');
